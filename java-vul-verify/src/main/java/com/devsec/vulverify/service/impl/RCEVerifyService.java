...
@Service
public class RCEVerifyService implements VulnerabilityVerifyService {
    ...
    public VerifyResponse verify(VerifyRequest request) {
        ...
        try {
            String[] cmd = {"sh", "-c", "ping -c 1 -W 1 " + payload};
            ...
            if (exitCode == 0) {
                return VerifyResponse.success("Command executed successfully", output.toString());
            } else {
                return VerifyResponse.success("Command executed with errors", output.toString());
            }
        } catch (Exception e) {
